...
function ajaxRequest(aElement, aUrl, objectType){
    ...
    req.onreadystatechange = function(){
        ...
        for(var x = 0; x < results.length; x ++){
                        ...
                        }else if(object_type == 'location_type'){
                            li.innerHTML = results[x].name;
                            li.setAttribute('tstvalue', results[x].id)
                            li.setAttribute('id', results[x].id);
                        }else if(object_type == 'service_point'){
                            li.innerHTML = results[x].name;
                            li.setAttribute('tstvalue', results[x].id)
                            li.setAttribute('id', results[x].id);
                        }else if(object_type == 'register'){
                            li.innerHTML = results[x].number;
                            li.setAttribute('tstvalue', results[x].id)
                            li.setAttribute('id', results[x].id);
                        }
